...
public class SearchMiddleTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_middle_two);
        ...
        databaseReference.child("Search").child("faculty").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (full_des1.toLowerCase().contains(searchedString.toLowerCase())) {
...
*/
                ...
                searchAdapter = new SearchAdapter(SearchMiddleTwo.this, full_name, full_des, full_dep,full_email,full_phone);
