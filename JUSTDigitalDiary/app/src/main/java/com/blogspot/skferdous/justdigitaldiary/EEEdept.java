    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  DialogBox box = new DialogBox();
       // box.show(getSupportFragmentManager(),"Alert Dialog Box ");
        Toast.makeText(EEEdept.this, "Internet connection is required for initial data synchronization.......!", Toast.LENGTH_SHORT).show();


        reference = FirebaseDatabase.getInstance().getReference().child("Campus").child("eee");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                LinearLayoutManager manager= new LinearLayoutManager(EEEdept.this);
                RecyclerView.LayoutManager layoutManager= manager;
                recyclerView.setLayoutManager(layoutManager);
                Toast.makeText(EEEdept.this, "This is updated list from database.......!", Toast.LENGTH_SHORT).show();



                secondlayoutadapter adapter= new secondlayoutadapter(EEEdept.this,model);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(EEEdept.this, "Oops....Something Wrong", Toast.LENGTH_SHORT).show();
