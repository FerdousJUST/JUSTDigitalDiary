...
public class NameFragment extends AppCompatActivity {
...
*/
                ...
                searchAdapter = new SearchAdapter(NameFragment.this, full_name, full_des, full_dep,full_email,full_phone);
