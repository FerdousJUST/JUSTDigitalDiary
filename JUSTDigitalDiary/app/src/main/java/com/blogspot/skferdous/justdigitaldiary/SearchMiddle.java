...
public class SearchMiddle extends AppCompatActivity {
...
*/
                ...
                searchAdapter = new SearchAdapter(SearchMiddle.this, full_name, full_des, full_dep,full_email,full_phone);
